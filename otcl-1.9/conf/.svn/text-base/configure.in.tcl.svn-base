...
dnl $Header: /home/narwhal/u0/soohyunc/CVS_SERV/USN/otcl-1.9/conf/configure.in.tcl,v 1.1.1.1 2005/06/16 23:35:06 soohyunc Exp $ (LBL)

AC_ARG_WITH(tcl,	--with-tcl=path	specify a pathname for tcl, d=$withval, d="")

AC_ARG_WITH(tcl-ver, --with-tcl-ver=path specify the version of tcl/tk, TCL_VERS=$withval, TCL_VERS=8.4.5)
